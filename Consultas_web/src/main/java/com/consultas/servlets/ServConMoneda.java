...
@WebServlet("/ServConMoneda")
public class ServConMoneda extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.print("  <title>Consulta de Monedas</title>");
        ...
        out.print("  <h3>Top Monedas mas usadas</h3>");
        ...
        try (
                ...
                ResultSet rs = stmt.executeQuery("SELECT m.id, m.nombre, COUNT(f.moneda_id) AS cantidad\n" +
                        "FROM factura f\n" +
